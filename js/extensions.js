/*
    ...
    (2)  Responsive Tabs (tabs to accordions)
    (3)  Slide Animation
    (4)  Lightbox
*/
...
/* ------------------------------------------------------------------- */
/* (2) Responsive-Tabs (tabs convert to accordions) */
...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    $(document.body).append('<div id="' + this.modal_id + '" class="ekko-lightbox modal fade" tabindex="-1"><br><br><div class="modal-dialog"><div class="modal-content">' + header + '<div class="modal-body"><div class="ekko-lightbox-container"><div></div></div></div>' + footer + '</div></div></div>');
